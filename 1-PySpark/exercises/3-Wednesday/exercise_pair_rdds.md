# Exercise: Pair RDDs and Word Count

## Overview
Implement the classic Word Count and other key-value operations using Pair RDDs.
...
dept_counts = # YOUR CODE using mapValues and reduceByKey
...
1. `pair_rdds.py` - Complete script with all tasks
2. Output showing all results

---

## Definition of Done

- [ ] Word Count produces correct word frequencies
- [ ] Understand why reduceByKey is preferred over groupByKey
- [ ] All four join types produce expected results
- [ ] Aggregation operations (count, sum, average) work correctly
- [ ] sortByKey works in both directions
- [ ] Script runs without errors

---

## Additional Resources
- Written Content: `key-value-pair-rdds.md`
- Demo: `demo_pair_rdds.py`
