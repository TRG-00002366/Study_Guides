...
from pyspark.sql.functions import col, sum as spark_sum, avg, count, row_number, rank, desc
...
# YOUR SOLUTION:
# result = emp_data.filter(...).groupBy(...).agg(...).filter(...).orderBy(...)
...
Problem 1 (Cleaning):    ___
Problem 2 (Windows):     ___
Problem 3 (Joins):       ___
Problem 4 (Optimization):___
Problem 5 (SQL):         ___
Problem 6 (Concepts):    ___
